        ...
        <Backdrop className={classes.backdrop} open={props.isloading}>
            ...
            <Form>
                ...
                <Modal.Footer id="modalbuttons">
                   <Link to="/chat"><button type="submit" className="btn btn-default">Start Chat</button></Link>
                   <Link to="/videocall"> <button type="submit" className="btn btn-default">Start Meet</button></Link>
                </Modal.Footer>
            </Form>
        </Modal>    
    );
...
const MeetCard = () => {
    ...
    function createMeet(){
        ...
        axios.get("/call/create").then((res)=>{
            ...
            setisloading(false);
            setMessage(res.data.message);
            console.log("by api",res.data.meetingCode,res.data.password);
